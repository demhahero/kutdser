$(document).ready(function () {
    ...
    function setupInternetForm() {
        $("div.internet label.subscriber-on").hide();
        $("div.internet input.modem-off").prop("checked", true);
        $("div.internet input.router-off").prop("checked", true);
        $("div.internet input.subscriber-off").prop("checked", true);

        $("div.internet div.modem-inventory-list").hide();
        //jQuery( "div.modem-info" ).hide();

        $("div.internet input.subscriber").change(function () {
            if (this.value == "yes") {
                $("div.internet div.installation").hide();
                $("div.internet label.subscriber-on").show();
            } else {
                $("div.internet div.installation").show();
                $("div.internet label.subscriber-on").hide();
            }
        });

        $("div.internet input.modem").change(function () {
            if (this.value == "rent") {
                $("div.internet div.modem-inventory-list").hide();
                $("div.internet div.modem-info").hide();
            } else if (this.value == "own_modem") {
                $("div.internet div.modem-inventory-list").hide();
                $("div.internet div.modem-info").show();
            } else if (this.value == "inventory") {
                $("div.internet div.modem-info").hide();
                $("div.internet div.modem-inventory-list").show();
            }
        ...
        $('div.internet #datePicker1').prop("readonly", true);
        $('div.internet #datePicker2').prop("readonly", true);
        $('div.internet #datePicker3').prop("readonly", true);
        $('div.internet #datePicker4').prop("readonly", true);
        $('div.internet #datePicker5').prop("readonly", true);

        $('div.internet #datePicker4').datepicker({
            format: 'mm/dd/yyyy',
            daysOfWeekDisabled: [0, 6],
            startDate: '+' + fistDayCancelattion + 'd'
        });
        $('div.internet #datePicker5').datepicker({
            format: 'mm/dd/yyyy',
            startDate: '+' + fistDayInstallation + 'd',
            daysOfWeekDisabled: [0, 6],
            endDate: currentDate
        });
        $('div.internet #datePicker2').datepicker({
            format: 'mm/dd/yyyy',
            startDate: '+' + fistDayInstallation + 'd',
            daysOfWeekDisabled: [0, 6],
            endDate: currentDate
        });
        $('div.internet #datePicker3').datepicker({
            format: 'mm/dd/yyyy',
            startDate: '+' + fistDayInstallation + 'd',
            daysOfWeekDisabled: [0, 6],
            endDate: currentDate
        ...
        $("div.internet input.plan-monthly").prop("checked", true);

        $('div.internet #check-service-availability').click(function () {
    ...
    $(".product-internet").click(function () {
        ...
        $("div.internet").show();
        $("div.internet :input").attr("disabled", false);
        $("div.internet select").attr("disabled", false);
