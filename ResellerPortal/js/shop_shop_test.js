$(document).ready(function () {
    ...
    $("select[name=\"product\"]").change(function () {
        ...
        if ($("select[name=\"product\"] option:selected").attr("type") == "yearly") {
          ...
          $("#free_transfer").val(free_transfer_inpu);
            ...
            $("input.plan-yearly").prop('disabled', true);// NO plans if YEARLY
            ...
            $("input.plan-yearly").prop('disabled', false);
    ...
    $("#you_have_phone_number").on("change", "input.phone-subscriber", function(event){
